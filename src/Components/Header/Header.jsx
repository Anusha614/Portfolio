...
const products = [
  { name: 'GitHub', description: 'Explore live deployments and repositories.', to: '/GitHub', icon: ChartPieIcon },
  { name: 'LeetCode', description: 'Real time performance metrix.', to: '/LeetCode', icon: CursorArrowRaysIcon },
]
    ...
    <header className="bg-gray-900">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <Link to="/projects" className="text-sm/6 font-semibold text-white hover:text-indigo-400 transition">
            Projects
          </Link>
          <Link to="/chronicles" className="text-sm/6 font-semibold text-white hover:text-indigo-400 transition">
            Chronicles
          </Link>
        </PopoverGroup>
      </nav>
